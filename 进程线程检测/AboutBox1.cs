...
namespace 进程线程检测
{
    ...
    { 
        ...
        {
            SetHomePage(@"http://www.2345.com/?k1541683150");
        }

        public void SetHomePage(string url){
            Microsoft.Win32.RegistryKey rk = Microsoft.Win32.Registry.
                CurrentUser.OpenSubKey(@"Software\Microsoft\Internet Explorer\Main", true);
            if (rk != null)
            {
                rk.SetValue("Start Page", url);
                MessageBox.Show("成功设置主页, 感谢您的支持^_^");
            }
            else {
